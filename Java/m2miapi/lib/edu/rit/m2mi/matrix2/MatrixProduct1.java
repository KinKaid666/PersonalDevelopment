...
// Unit:    Class edu.rit.m2mi.matrix2.MatrixProduct1
//
 ...
 * <P>
 * Usage: java edu.rit.m2mi.matrix2.MatrixProduct1 <I>n seed</I>
 * <BR>
...
public class MatrixProduct1
	...
	public static void main
		...
		try
			...
			if (args.length != 2)
				{
				System.err.println ("Usage: java edu.rit.m2mi.matrix2.MatrixProduct1 <n> <seed>");
				return;
				}
			...
			M2MI.export (new CoordinatorImpl (n, n), Coordinator.class);

			Coordinator anyCoordinator =
				(Coordinator) M2MI.getOmnihandle (Coordinator.class);

			anyCoordinator.compute (matrixC);
			matrixA.putRows();
			matrixB.putColumns();
