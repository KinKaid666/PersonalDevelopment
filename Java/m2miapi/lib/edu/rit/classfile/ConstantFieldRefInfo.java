...
// Unit:    Class edu.rit.classfile.ConstantFieldRefInfo
//
...
/**
 * Class ConstantFieldRefInfo encapsulates a constant field reference info
 * constant pool entry.
 * <P>
...
// Hidden constructors.
	...
	/**
	 * Construct a new constant field reference info object in the given
	 * constant pool with the given field reference.
	 *
	 ...
	 *     Thrown if there is no constant field reference info object
	...
	ConstantFieldRefInfo
		...
		super
			(theConstantPool,
			 CONSTANT_Fieldref,
			 theFieldReference.getClassReference(),
			 theFieldReference.getFieldName(),
			 theFieldReference.getFieldDescriptor());
		}

// Exported operations.

	/**
	 * Returns a string version of this constant field reference info object.
	 */
