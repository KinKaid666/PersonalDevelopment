//******************************************************************************
//
// File:    FloatLdcInstruction.java
// Package: edu.rit.classfile
// Unit:    Class edu.rit.classfile.FloatLdcInstruction
//
...
/**
 * Class FloatLdcInstruction encapsulates a Java bytecode instruction that
...
// Hidden constructors.
	...
	/**
	 * Construct a new float load constant instruction with the given float
	 * constant.
	 *
	 * @param  theConstant   Float constant.
	 */
	FloatLdcInstruction
		(float theConstant)
		{
...
// Exported operations.
	...
	/**
	 * Returns the float constant this float load constant instruction
	 * refers to.
	 */
...
// Hidden operations to be implemented in a subclass.
	...
	/**
	 * Returns the constant pool index for this float load constant
	...
	int getConstantPoolIndex
		...
		{
		return theConstantPool.getConstantFloatInfo (myConstant);
		}
