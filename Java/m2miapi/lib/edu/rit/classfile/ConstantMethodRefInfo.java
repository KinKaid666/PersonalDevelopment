...
// Unit:    Class edu.rit.classfile.ConstantMethodRefInfo
//
...
/**
 * Class ConstantMethodRefInfo encapsulates a constant method reference info
 * constant pool entry.
 * <P>
...
// Hidden constructors.
	...
	/**
	 * Construct a new constant method reference info object in the given
	 * constant pool with the given subroutine reference.
	 *
	 ...
	 *     Thrown if there is no constant method reference info object
...
// Exported operations.
	...
	/**
	 * Returns a string version of this constant method reference info object.
	 */
