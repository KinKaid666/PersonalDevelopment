...
public class BlackjackStrategy {
    ...
    // Getters
    public HashMap<Integer, HashMap<Card, StrategicMove>> getPairStrategies()      { return pairStrategies_      ; }
    public HashMap<Integer, HashMap<Card, StrategicMove>> getSoftTotalStrategies() { return softTotalStrategies_ ; }
    public HashMap<Integer, HashMap<Card, StrategicMove>> getHardTotalStrategies() { return hardTotalStrategies_ ; }
    public HashMap<Integer, HashMap<Card, StrategicMove>> getSurrenderStrategies() { return surrenderStrategies_ ; }
    ...
    public void printHandHistogramCSV(PrintStream o) { stats_.printHandHistogramCSV(o) ; }
    ...
    public Blackjack.Move getHandDecision(BlackjackRules r, BlackjackHand h, Card dealerUpcard) throws Exception {
        ...
        //System.out.println("getHandDecision(rules: " + r + ", hand: " + h + ", dealerUpcard: " + dealerUpcard) ;
