...
// The size of physical memory in pages. Can be modified at runtime.
unsigned int NumPhysPages = 32;
...
Machine::Machine(bool debug)
{
    ...
    DEBUG('m', "Memory size: %d pages, %d bytes\n",NumPhysPages,
	  MemorySize);
    
    for (ui = 0; ui < MemorySize; ui++)
      	mainMemory[ui] = 0;
#ifdef USE_TLB
