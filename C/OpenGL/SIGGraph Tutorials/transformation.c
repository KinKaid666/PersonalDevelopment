/*
    orthoTrans.c
    Nate Robins, 1997
    Modified version of transformations.c by Nan Schaller, 2001
...
/* Added by ncs on 10/22/01 */
enum {
    ORTHO, PERSPECTIVE
} mode = ORTHO;


/*  ncs replaced this eye point so that perspective
and ortho views would be about the same initial size */
/*  GLfloat eye[3] = { 0.0, 0.0, 2.0 }; */
GLfloat eye[3] = { 0.0, 0.0, 2.3 };
...
/*  modified to add glOrtho option  by ncs 10/22/01 */
    if (mode == PERSPECTIVE)
...
main(int argc, char** argv)
{
    ...
    glutAddMenuEntry("", 0);
/* next two menu items added by ncs 10/22/01 */
