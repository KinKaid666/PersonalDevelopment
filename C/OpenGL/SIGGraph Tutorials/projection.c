/*
    projection.c
    Nate Robins, 1997
    Modified, 2001 by Nan Schaller (ncs) so that the initial
    	projections for each type of projection will be approximately
	the same view AND that the back clipping plane would be the 
	same for each.  It is Nan's theory that this will make it
	easier for students to do comparisons between the various
	projections.
...
*/
	perspective[0].value = 54.0;
	perspective[1].value = 1.6;
	perspective[2].value = 1.0;
	perspective[3].value = 3.5;
...
/*
	...
	frustum[5].value = 3.5;
*/
	frustum[0].value = -0.55;
	frustum[1].value = 0.55;
	frustum[2].value = -0.55;
	frustum[3].value = 0.50;
	frustum[4].value = 1.0;
	frustum[5].value = 3.5;
